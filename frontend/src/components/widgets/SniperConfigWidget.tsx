    ...
    <div className="bg-background-card border border-white/5 rounded-2xl p-4 shadow-xl relative overflow-hidden flex flex-col h-full">
      ...
      <div className="flex items-center justify-between mb-4 border-b border-white/5 pb-3">
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className="ml-2 px-1.5 py-0.5 rounded border border-white/10 bg-white/5 text-[8px] font-black text-text-muted hover:text-accent-cyan hover:border-accent-cyan/30 transition-all"
          >
            TEST
          </button>
        </div>
      ...
      <div className="space-y-4 overflow-y-auto pr-1 custom-scrollbar">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-[10px] font-bold text-accent-cyan uppercase tracking-tighter">
        ...
        {/* Safety Filters */}
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-[10px] font-bold text-accent-pink uppercase tracking-tighter">
            <ShieldCheck className="w-3 h-3" />
            <span>Safety Filters</span>
          </div>
          
          <div className="space-y-1.5">
            <div className="bg-black/20 border border-white/5 rounded-xl p-2 flex items-center justify-between">
              ...
              <div className="flex items-center gap-1 bg-black/40 px-2 py-1 rounded-lg border border-white/10">
                <input 
                  ...
                  className="w-8 bg-transparent border-none text-[10px] font-mono text-accent-cyan outline-none text-right"
                />
            ...
            <button 
              ...
              className={cn(
                ...
                settings.requireMintRenounced ? "bg-accent-cyan/5 border-accent-cyan/20" : "bg-black/20 border-white/5"
              )}
            >
              <div className="flex items-center gap-2">
                <Coins className={cn("w-3 h-3", settings.requireMintRenounced ? "text-accent-cyan" : "text-text-muted")} />
            ...
            <button 
              ...
              className={cn(
                "w-full p-2 rounded-xl border flex items-center justify-between transition-all",
                settings.requireLPBurned ? "bg-accent-pink/5 border-accent-pink/20" : "bg-black/20 border-white/5"
              )}
            >
              <div className="flex items-center gap-2">
                <Flame className={cn("w-3 h-3", settings.requireLPBurned ? "text-accent-pink" : "text-text-muted")} />
      ...
      <div className="mt-auto pt-4 shrink-0 flex flex-col gap-2">
         {!engineActive ? (
           <button 
             ...
             className={cn(
               "w-full py-3 bg-gradient-to-r from-accent-cyan to-accent-purple text-black font-black uppercase tracking-widest text-[10px] rounded-xl hover:opacity-90 active:scale-95 transition-all shadow-lg shadow-accent-cyan/10 flex items-center justify-center gap-2",
           ...
           <button 
             ...
             disabled={isDeploying}
             className={cn(
               "w-full py-3 bg-white/5 border border-accent-pink/30 text-accent-pink font-black uppercase tracking-widest text-[10px] rounded-xl hover:bg-accent-pink/10 active:scale-95 transition-all flex items-center justify-center gap-2",
               isDeploying && "opacity-50 cursor-not-allowed"
             )}
           >
