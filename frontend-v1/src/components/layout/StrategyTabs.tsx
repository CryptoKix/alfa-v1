...
export const StrategyTabs = () => {
  ...
  return (
    <div className="flex items-center gap-1.5 bg-white/[0.02] p-1.5 rounded-lg border border-border backdrop-blur-md">
      {STRATEGIES.map((strat) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative px-5 py-2.5 flex items-center gap-2.5 rounded-md transition-all duration-300 group border",
              isSelected 
