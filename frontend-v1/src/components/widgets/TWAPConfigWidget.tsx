      ...
      <div className="lg:w-[380px] bg-background-card border border-accent-pink/30 rounded-lg p-4 shadow-floating relative overflow-hidden flex flex-col gap-4 shrink-0 h-full">
        ...
        <div className="flex items-center justify-between mb-1 border-b border-accent-pink/30 shrink-0 h-[55px] -mx-4 px-4 -mt-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-xs font-bold text-white uppercase tracking-tight">TWAP CONFIG</h2>
            </div>
          </div>
        ...
        <div className="space-y-3 flex-1 overflow-auto custom-scrollbar pr-1 min-h-0">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="space-y-1.5 relative">
              <label className="text-[9px] uppercase tracking-widest text-text-muted font-bold px-1 text-accent-purple">Spend Asset</label>
              <button 
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <div className="bg-background-elevated border border-border rounded-md p-2.5 flex items-center gap-2 focus-within:border-accent-purple transition-colors h-12">
                <input 
                  type="number" 
                  value={duration}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              <label className="text-[9px] uppercase tracking-widest text-text-muted font-bold px-1 text-accent-purple">Snipe Profit (%)</label>
        ...
        {status === 'success' && <div className="p-2 bg-accent-purple/10 border border-accent-green/20 rounded-lg text-[8px] text-accent-purple font-bold animate-in fade-in text-center uppercase tracking-widest">TWAP Deployed</div>}
      ...
      <div className="flex-1 bg-background-card border border-accent-pink/30 rounded-lg p-4 shadow-floating relative overflow-hidden flex flex-col gap-4 min-h-0 h-full">
        ...
        <div className="flex-1 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-background-elevated/50 border border-border rounded-md p-4">
              ...
              <div className="text-[9px] text-accent-purple uppercase tracking-widest mt-1">Total Executions</div>
            </div>
            <div className="bg-background-elevated/50 border border-border rounded-md p-4">
          ...
          <div className="bg-background-elevated/30 border border-dashed border-border rounded-lg p-6 flex flex-col items-center justify-center text-center gap-4">
          ...
          <div className="bg-black/20 rounded-md p-4 border border-border">
            ...
            {twapTrades.length > 0 ? (
              <div className="space-y-1">
                {twapTrades.map(trade => {
                  ...
                  const typeColor = txType === 'BUY' ? "text-accent-purple" : txType === 'SELL' ? "text-accent-purple" : "text-accent-purple"

                  return (
                    <div key={trade.id} className="grid grid-cols-[100px_80px_1fr_80px_50px] gap-2 items-end p-2 rounded-lg bg-background-elevated/30 border border-border hover:border-border transition-all group font-mono whitespace-nowrap overflow-hidden text-[10px]">
                      <div className={cn(
                      ...
                      <div className="text-right shrink-0 leading-none">
                        <span className={cn(
                          ...
                          isSuccess ? "text-accent-purple border-accent-green/20 bg-accent-green/5" : "text-accent-red border-accent-red/20 bg-accent-red/5"
                        )}>
                          {isSuccess ? 'OK' : 'ERR'}
                        </span>
                      </div>
