    ...
    <div className="flex flex-col lg:flex-row gap-2 h-full animate-in fade-in slide-in-from-bottom-4 duration-500 min-h-0">
      ...
      <div className="lg:w-[380px] bg-background-card border border-accent-pink/30 rounded-lg p-4 shadow-floating relative overflow-hidden flex flex-col gap-4 shrink-0 h-full">
        ...
        <div className="space-y-3 flex-1 overflow-auto custom-scrollbar pr-1 min-h-0">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="space-y-1.5 relative">
              ...
              <button 
                ...
                className="w-full bg-background-elevated border border-border rounded-md p-2.5 flex items-center justify-between hover:bg-white/5 transition-colors h-12"
              >
                <div className="flex items-center gap-2">
            ...
            <div className="space-y-1.5 relative">
              <label className="text-[9px] uppercase tracking-widest text-text-muted font-bold px-1 text-accent-cyan">Trade Asset</label>
              <button 
          ...
          <div className="space-y-1.5">
            ...
            <div className="bg-background-elevated border border-border rounded-md p-2.5 flex items-center gap-2 focus-within:border-accent-cyan transition-colors h-12">
              <input 
                type="text" 
                value={alias}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <div className="bg-background-elevated border border-border rounded-md p-2.5 flex items-center gap-2 focus-within:border-accent-green transition-colors h-12">
                <input 
                  type="number" 
                  value={lowerPrice}
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex bg-black/20 rounded-md p-1 border border-border gap-1 h-12">
              <button
          ...
          <div className="space-y-1.5">
            ...
            <div className="bg-background-elevated border border-border rounded-md p-2 flex items-center gap-3 h-12">
          ...
          <div className="grid grid-cols-[1fr_120px] gap-3 pt-1">
            <div className="space-y-1.5">
              ...
              <div className="bg-background-elevated border border-border rounded-md p-2 flex items-center gap-2 h-12">
            ...
            <div className="space-y-1.5">
              ...
              <button 
                ...
                className={cn(
                  "w-full h-12 rounded-md border transition-all flex items-center justify-center gap-2 group",
                  trailingEnabled 
                    ? "bg-accent-cyan/10 border-accent-cyan text-accent-cyan shadow-[0_0_15px_rgba(0,255,255,0.1)]" 
                    : "bg-background-elevated border-border text-text-muted hover:bg-white/5"
                )}
              >
      ...
      <div className="flex-1 bg-background-card border border-accent-pink/30 rounded-lg p-4 shadow-floating relative overflow-hidden flex flex-col gap-4 min-h-0 h-full">
        ...
        <div className="flex-1 bg-black/20 rounded-md border border-border overflow-hidden flex flex-col min-h-0">
          <div className="grid grid-cols-[100px_80px_1fr_80px_50px] gap-2 px-4 pt-3 pb-2 text-[8px] font-black text-text-muted uppercase tracking-widest shrink-0 border-b border-accent-pink/30 bg-white/[0.02]">
            <div>Time</div>
            <div>Type</div>
            <div>Details</div>
            <div>Price</div>
            ...
            {gridTrades.length > 0 ? (
              <div className="space-y-1">
                {gridTrades.map(trade => {
                  ...
                  return (
                    <div key={trade.id} className="grid grid-cols-[100px_80px_1fr_80px_50px] gap-2 items-end p-2 rounded-lg bg-background-elevated/30 border border-border hover:border-border transition-all group font-mono whitespace-nowrap overflow-hidden">
                      <div className={cn(
