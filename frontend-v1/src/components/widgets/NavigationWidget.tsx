...
export const NavigationWidget = () => {
  ...
  return (
    <aside className="w-20 md:w-64 bg-background-card border border-accent-pink/30 rounded-lg flex flex-col shrink-0 h-full relative overflow-hidden shadow-floating px-4 pb-4">

      <div className="h-16 flex items-center justify-center border-b border-accent-pink/30 mb-2 shrink-0">
        <div className="hidden md:flex items-center gap-3">
          <img src="/logo_concept_5.svg" alt="Tactix" className="w-16 h-16 drop-shadow-glow-cyan" />
          <h1 className="text-xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-accent-cyan to-accent-pink leading-none">
            TACTIX.sol
          </h1>
        </div>
        <div className="md:hidden flex items-center justify-center">
          <img src="/logo_concept_5.svg" alt="T" className="w-14 h-14 drop-shadow-glow-cyan" />
        </div>
      </div>
